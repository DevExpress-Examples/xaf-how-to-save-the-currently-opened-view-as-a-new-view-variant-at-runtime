...
using ViewVariantSaveEF.Blazor.Server.Services;
...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<ViewVariantSaveEFBlazorApplication>();
            builder.Modules
            	...
            	.Add<ViewVariantSaveEFBlazorModule>();
            builder.ObjectSpaceProviders
                .AddSecuredEFCore(options => options.PreFetchReferenceProperties())
                    .WithDbContext<ViewVariantSaveEF.Module.BusinessObjects.ViewVariantSaveEFEFCoreDbContext>((serviceProvider, options) => {
