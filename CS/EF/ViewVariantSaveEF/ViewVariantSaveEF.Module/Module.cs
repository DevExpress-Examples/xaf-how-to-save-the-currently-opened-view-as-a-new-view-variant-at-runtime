...
public sealed class ViewVariantSaveEFModule : ModuleBase {
    public ViewVariantSaveEFModule() {
		// 
		// ViewVariantSaveEFModule
		// 
		AdditionalExportedTypes.Add(typeof(ViewVariantSaveEF.Module.BusinessObjects.ApplicationUser));
