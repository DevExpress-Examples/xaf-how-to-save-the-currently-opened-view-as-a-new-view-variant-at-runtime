...
Namespace UserViewVariants
    ...
    Public Class UserViewVariantsController
        ...
        Public Sub New()
            userViewVariantsCore = New SingleChoiceAction(Me, UserViewVariants.UserViewVariantsController.STR_UserViewVariants_Id, PredefinedCategory.View) With {.ImageName = UserViewVariants.UserViewVariantsController.STR_UserViewVariants_Image, .PaintStyle = ActionItemPaintStyle.CaptionAndImage, .Caption = CaptionHelper.ConvertCompoundName(UserViewVariants.UserViewVariantsController.STR_UserViewVariants_Id), .ItemType = SingleChoiceActionItemType.ItemIsOperation, .ShowItemsOnClick = True}
            Dim addViewVariantItem As ChoiceActionItem = New ChoiceActionItem(UserViewVariants.UserViewVariantsController.STR_NewViewVariant_Id, CaptionHelper.ConvertCompoundName(UserViewVariants.UserViewVariantsController.STR_NewViewVariant_Id), UserViewVariants.UserViewVariantsController.STR_NewViewVariant_Id) With {.ImageName = UserViewVariants.UserViewVariantsController.STR_NewViewVariant_Image}
            Dim removeViewVariantItem As ChoiceActionItem = New ChoiceActionItem(UserViewVariants.UserViewVariantsController.STR_DeleteViewVariant_Id, CaptionHelper.ConvertCompoundName(UserViewVariants.UserViewVariantsController.STR_DeleteViewVariant_Id), UserViewVariants.UserViewVariantsController.STR_DeleteViewVariant_Id) With {.ImageName = UserViewVariants.UserViewVariantsController.STR_DeleteViewVariant_Image}
            Dim editViewVariantItem As ChoiceActionItem = New ChoiceActionItem(UserViewVariants.UserViewVariantsController.STR_EditViewVariant_Id, CaptionHelper.ConvertCompoundName(UserViewVariants.UserViewVariantsController.STR_EditViewVariant_Id), UserViewVariants.UserViewVariantsController.STR_EditViewVariant_Id) With {.ImageName = UserViewVariants.UserViewVariantsController.STR_EditViewVariant_Image}
        ...
        Protected Overridable Sub UserViewVariants(ByVal e As SingleChoiceActionExecuteEventArgs)
            ...
            If data Is UserViewVariants.UserViewVariantsController.STR_NewViewVariant_Id OrElse data Is UserViewVariants.UserViewVariantsController.STR_EditViewVariant_Id Then
                ShowViewVariantParameterDialog(e, data)
            ElseIf data Is UserViewVariants.UserViewVariantsController.STR_DeleteViewVariant_Id Then
                DeleteViewVariant()
            End If
        End Sub
        ...
        Protected Overridable Sub ShowViewVariantParameterDialog(ByVal e As SingleChoiceActionExecuteEventArgs, ByVal mode As String)
            ...
            Dim parameter As ViewVariantParameterObject = New ViewVariantParameterObject(rootModelViewVariants)
            If mode Is UserViewVariants.UserViewVariantsController.STR_NewViewVariant_Id Then
            ...
            If mode Is UserViewVariants.UserViewVariantsController.STR_EditViewVariant_Id AndAlso changeVariantController IsNot Nothing AndAlso changeVariantController.ChangeVariantAction.SelectedItem IsNot Nothing Then
        ...
        Protected Sub dialogController_Accepting(ByVal sender As Object, ByVal e As DialogControllerAcceptingEventArgs)
            ...
            If data Is UserViewVariants.UserViewVariantsController.STR_NewViewVariant_Id Then
                NewViewVariant(parameter)
            ElseIf data Is UserViewVariants.UserViewVariantsController.STR_EditViewVariant_Id Then
        ...
        Protected Overridable Sub NewViewVariant(ByVal parameter As ViewVariantParameterObject)
            ...
            Dim newModelViewVariant As IModelVariant = CType(rootModelViewVariants, ModelNode).AddNode(Of IModelVariant)(newViewVariantId) ' Adds a new child node of the IModelVariant type with a specific identifier to the parent IModelViewVariants node.
            newModelViewVariant.View = TryCast(CType(modelViews, ModelNode).AddClonedNode(CType(View.Model, ModelNode), newViewVariantId), IModelView) ' Creates a new node of the IModelView type by cloning the settings of the current View and then sets the clone to the View property of the view variant created above. Beware of the specificity described at Q411979.
        ...
        Protected Overridable Sub DeleteViewVariant() 'This method does almost the same work as NewViewVariant, but in reverse order.
            ...
            If variantsInfo IsNot Nothing AndAlso Not Equals(variantsInfo.CurrentVariantId, GetRootViewId()) Then
        ...
        Private Sub UpdateUserViewVariantsAction()
            ...
            UserViewVarintsAction.Items.FindItemByID(CStr(UserViewVariants.UserViewVariantsController.STR_EditViewVariant_Id)).Enabled(UserViewVariants.UserViewVariantsController.STR_HasViewVariants_EnabledKey) = hasViewVariants
            UserViewVarintsAction.Items.FindItemByID(CStr(UserViewVariants.UserViewVariantsController.STR_DeleteViewVariant_Id)).Enabled(UserViewVariants.UserViewVariantsController.STR_HasViewVariants_EnabledKey) = UserViewVarintsAction.Items.FindItemByID(CStr(UserViewVariants.UserViewVariantsController.STR_EditViewVariant_Id)).Enabled(UserViewVariants.UserViewVariantsController.STR_HasViewVariants_EnabledKey)
            If changeVariantController IsNot Nothing AndAlso changeVariantController.ChangeVariantAction.SelectedItem IsNot Nothing Then
                ...
                UserViewVarintsAction.Items.FindItemByID(CStr(UserViewVariants.UserViewVariantsController.STR_DeleteViewVariant_Id)).Enabled(UserViewVariants.UserViewVariantsController.STR_IsRootViewVariant_EnabledKey) = Not Equals(variantInfo.ViewID, GetRootViewId())
            End If
        End Sub
